...
public void ModificarCliente (string p_Cliente_OID, string p_nombre, string p_direccion, string p_telefono, String p_pass)
{
        ClienteEN clienteEN = null;
        ...
        _IClienteRepository.ModificarCliente (clienteEN);
}
...
public ClienteEN DamePorOID (string DNI
                             )
{
        ClienteEN clienteEN = null;

        clienteEN = _IClienteRepository.DamePorOID (DNI);
        return clienteEN;
}
...
public System.Collections.Generic.IList<ClienteEN> DameTodos (int first, int size)
{
        ...
        list = _IClienteRepository.DameTodos (first, size);
        return list;
}

...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: RentaCar2GenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("RentaCar2GenNHibernate", "nhibernateUser", "nhibernatePass");
